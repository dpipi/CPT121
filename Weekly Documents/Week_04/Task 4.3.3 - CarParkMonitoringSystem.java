...
public class Task_4_3_3_CarParkMonitoringSystem
{
   private static final int LEVELS = 3;
   private static final int SPACES_PER_LEVEL = 30; 
   
   private static final boolean OCCUPIED = true;
   private static final boolean VACANT = false;
   
   private final static boolean INVALID_SPACE = false;
   
   // this array declaration needs to be updated
   private static final boolean [][] carParkSpaces = 
                                     new boolean[LEVELS][SPACES_PER_LEVEL];
